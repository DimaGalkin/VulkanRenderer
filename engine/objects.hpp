...
namespace tdl {
    ...
    template <typename ModelT> class shared_model final {
        public:
            ...
            shared_model<Model> operator[] (
                ...
                if (ptr_->objects_.contains(key)) return ptr_->objects_.at(key);
                return nullptr;
            }
    ...
    */
    class Texture final {
        public:
            ...
            explicit Texture (
                const std::string& path,
                const tdl::File type = tdl::File::Image
            ) : type_ { type },
                path_ { path },
                color_ { 0, 0, 0, 0 }
            {}
    ...
    */
    class ObjectInterface {
        ...
        protected:
            ...
            virtual void recreateImageView (
                vk::Device device
            ) = 0;
    ...
    */
     ...
     *
     * Holds multiple objects and renders them, provides a transform to
    */
    class Model {
        public:
            friend class Vlkn;
